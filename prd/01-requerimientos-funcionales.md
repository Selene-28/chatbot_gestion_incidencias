...
| RF-02 | Consultar estado de incidencia | Consulta por número de ticket o por correo institucional. Muestra estado, categoría, fecha de registro, técnico asignado (si existe), última actualización y, si el ticket está Resuelto o Cerrado, la respuesta del técnico (máx. 1000 caracteres). En estados abiertos muestra las observaciones que agregó el técnico. Solo el propietario puede ver sus tickets (SEG-02). | Alta | Flujo F-03, API-02 |
